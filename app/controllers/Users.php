                ...
                if($_SERVER['REQUEST_METHOD'] == 'POST'){
                    ...
                    if(empty($data['email_err']) && empty($data['name_err']) && empty($data['password_err']) && empty($data['confirm_password_err']) && empty($data['firstname_err']) && empty($data['lastname_err'])){
                        ...
                        $message = '
                            ...
                            <br /><br />
                            <br/>
                            <p>To activate your account please click <a href="http://192.168.99.100:8080/users/confirm/?token='. $token .'">Here</a></p>
                            </p>
                            <p>
                                <br />--------------------------------------------------------
                ...
                if(empty($data['email_err']))
                {
                        ...
                        if($row->token == "")
                        {
                            ...
                            $message = '
                                ...
                                <body>
                                    <p>To recover your account please click here <a href="http:/192.168.99.100:8080//Camagru/users/changepass/?token='.$token .'"><button 
