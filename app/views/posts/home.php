    ...
    <nav aria-label="Page navigation example justify-content-center">
        <ul class="pagination justify-content-center">
            ...
            if(($data['currentPage']-1) > 0)
                echo '<li class="page-item"><a class="page-link" href="http://192.168.99.100:8080/Camagru/posts/home?page='.($data['currentPage']-1).'">Previous</a></li>';
            else
            ...
            for($i =1; $i <= $data['totalPages']; $i++){
                if($i == $data['currentPage'])
                    ...
                    echo '<li class="page-item"><a class="page-link" href="http://192.168.99.100:8080/Camagru/posts/home?page='.$i.'">'.$i.'</a></li>';
            }
            if(($data['currentPage']+1) <= $data['totalPages'])
                echo '<li class="page-item"><a class="page-link" href="http://192.168.99.100:8080/Camagru/posts/home?page='.($data['currentPage']+1).'">Next</a></li>';
            else
